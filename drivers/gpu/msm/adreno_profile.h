...
static inline int adreno_profile_process_results(struct adreno_device *adreno_dev) { return 0; }
static inline void adreno_profile_preib_processing(struct adreno_device *adreno_dev, struct adreno_context *drawctxt, unsigned int *cmd_flags, unsigned int **rbptr) { }
static inline void adreno_profile_postib_processing(struct adreno_device *adreno_dev, unsigned int *cmd_flags, unsigned int **rbptr) { }
